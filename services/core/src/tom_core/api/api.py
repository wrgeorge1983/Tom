...
from tom_core.inventory.inventory import InventoryStore, DeviceConfig, SchemaDeviceConfig
...
async def inventory(device_name: str, inventory_store: InventoryStore = Depends(get_inventory_store)) -> DeviceConfig:
