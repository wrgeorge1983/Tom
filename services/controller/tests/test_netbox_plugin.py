"""Tests for NetBox inventory plugin."""

import pytest
from unittest.mock import MagicMock, Mock


class TestNetBoxSettings:
    """Test NetBox plugin settings."""

    def test_settings_with_defaults(self):
        """NetBox settings apply defaults correctly."""
        import os
        ...
        try:
            ...
            assert settings.url == "https://netbox.example.com"
...
def _create_plugin(settings_overrides: dict):
    """Helper to create a plugin with mocked pynetbox."""
